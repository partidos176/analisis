...
function TratamientoApp({ videoInicial }) {
  ...
  const anadirTriangulo = () => {
    const id = Date.now();
    setFiguras(prev => [...prev, { id, tipo: 'triangulo', x: 0.5, y: 0.5, ancho: 0.06, alto: 0.35, color: '#f97316', opacidad: 0.7, crecimiento: 0.25 }]);
    ...
    const paso = (t) => {
      ...
      const e = 0.25 + 0.75 * (1 - Math.pow(1 - p, 2.5));
