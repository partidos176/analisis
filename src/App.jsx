                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '100%' }}>
                  ...
                  <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center' }}>
                      ...
                      <button
                        onClick={() => { if (logAction('PENAL + GOL', 'finalizacion')) { setPenalCount(prev => prev + 1); setPenalGolCount(prev => prev + 1); setGolesList(prev => [...prev, { name: '', tipo: 'PENAL', name2: '', accion: 'PENAL', team: 'home', periodo, minuto: Math.floor(timerSeconds / 60) }]); setActiveTab('goles'); } }}
                        style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#16a34a', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', minWidth: 'fit-content', textTransform: 'uppercase', letterSpacing: '0.05em' }}
                      >
                        <span>PENAL + GOL</span>
              ...
              {activeTab === 'tipogol' && (
                <div style={{
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.75rem' }}>
                    ...
                    <button onClick={() => { if (logAction('TIRO DERECHA', 'origengol')) { setOrigenGolTiroDerechaCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>TIRO DERECHA</span>
                    ...
                    <button onClick={() => { if (logAction('TIRO IZQUIERDA', 'origengol')) { setOrigenGolTiroIzquierdaCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>TIRO IZQUIERDA</span>
                    ...
                    <button onClick={() => { if (logAction('CENTRO DERECHA', 'origengol')) { setOrigenGolCentroDerechaCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>CENTRO DERECHA</span>
                    ...
                    <button onClick={() => { if (logAction('CENTRO IZQUIERDA', 'origengol')) { setOrigenGolCentroIzquierdaCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>CENTRO IZQUIERDA</span>
                    ...
                    <button onClick={() => { if (logAction('FALTA FRONTAL', 'origengol')) { setOrigenGolFaltaFrontalCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>FALTA FRONTAL</span>
                    ...
                    <button onClick={() => { if (logAction('FALTA DERECHA', 'origengol')) { setOrigenGolFaltaDerechaCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>FALTA DERECHA</span>
                    ...
                    <button onClick={() => { if (logAction('FALTA IZQUIERDA', 'origengol')) { setOrigenGolFaltaIzquierdaCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>FALTA IZQUIERDA</span>
                    ...
                    <button onClick={() => { if (logAction('CORNER DERECHA', 'origengol')) { setOrigenGolCornerDerechaCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>CORNER DERECHA</span>
                    ...
                    <button onClick={() => { if (logAction('PENAL', 'origengol')) { setOrigenGolPenalCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>PENAL</span>
                    ...
                    <button onClick={() => { if (logAction('ERROR RIVAL', 'origengol')) { setOrigenGolErrorRivalCount(prev => prev + 1); setActiveTab('acciones'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
