                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', width: '100%', maxWidth: '560px' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', alignItems: 'flex-start', order: 2 }}>
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', alignItems: 'stretch', width: '100%' }}>
                            ...
                            onChange={(e) => {
                              ...
                              if (g.team === 'away') {
                                setGolesRivalList(prev => {
                                  const updated = [...prev];
                                  const rivalIdx = updated.findIndex(rg => rg.periodo === g.periodo && rg.minuto === g.minuto);
                                  if (rivalIdx !== -1) updated[rivalIdx] = { ...updated[rivalIdx], accion: val };
                                  return updated;
                                });
                              }
                            }}
