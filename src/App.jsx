...
import cardenesImg from './jugadores/cardenes.jpg';
...
import lramirezImg from './jugadores/lramirez.jpg';
...
export default function App() {
  ...
  const [timelineRows2, setTimelineRows2] = useState([{ action: '', finalization: '', time: null }]);
  ...
  const saveMatchData = async (id) => {
    ...
    const payload = sanitizeForFirebase({
      ...
      despejeDefensaCount,
      despejePorteroCount,
      golCount: golesList.length,
      golRivalCount: golesRivalList.length,
      penalCount,
      penalFueraCount,
      penalGolCount,
      penalGolRivalCount,
            ...
            {timelineVideo ? (
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', marginTop: '0.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', order: -1, width: '100%', alignItems: 'center' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap', gap: '0.5rem' }}>
                    ...
                    {fin2EndTime !== null && (
                      <span style={{ color: '#ffffff', fontWeight: 700, fontSize: '0.9rem', fontFamily: 'var(--font-mono)', background: '#ef4444', padding: '0.2rem 0.5rem', borderRadius: '6px' }}>
                        {String(Math.floor(fin2EndTime / 60)).padStart(2, '0')}:{String(fin2EndTime % 60).padStart(2, '0')}
                      </span>
                    )}
                  </div>
              ...
              <div style={{ display: 'flex', gap: '1rem', marginTop: '0.5rem' }}>
                <div style={{ flex: 1, textAlign: 'center' }}>
                  <div style={{ fontWeight: 700, fontSize: '1.5rem', color: '#ffffff', textDecoration: 'underline' }}>
                    1ª PARTE
                  </div>
                  {timelineRows.length > 2 && (
                    <button onClick={() => setShowAllRows1(!showAllRows1)} style={{ background: '#6366f1', color: '#ffffff', border: 'none', borderRadius: '6px', padding: '0.2rem 0.6rem', fontWeight: 700, fontSize: '0.7rem', cursor: 'pointer', fontFamily: 'Inter, sans-serif', marginTop: '0.3rem' }}>
                      {showAllRows1 ? 'Mostrar menos' : `Ver todas (${timelineRows.length})`}
                    </button>
                  )}
                  <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '0.5rem', tableLayout: 'fixed' }}>
                    ...
                    <tbody>
                      {(showAllRows1 ? timelineRows : timelineRows.slice(-2)).map((row, idx) => {
                        const realIdx = showAllRows1 ? idx : timelineRows.length - 2 + idx;
                        return (
                        <tr key={realIdx}>
                          <td style={{ padding: '0.1rem 0.2rem', border: '1px solid var(--border-subtle)' }}>
                            ...
                            }} style={{ width: '100%', background: '#1e293b', color: '#ffffff', border: '1px solid var(--border-subtle)', borderRadius: '6px', padding: '0.1rem 0.2rem', fontWeight: 600, fontSize: '0.7rem', fontFamily: 'Inter, sans-serif', cursor: 'pointer' }}>
                          ...
                          <td style={{ padding: '0.1rem 0.2rem', border: '1px solid var(--border-subtle)', background: '#1e293b', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem' }}>
                            ...
                            {timelineRows.length > 0 && (
                              <button onClick={() => {
                                const updated = timelineRows.filter((_, i) => i !== realIdx);
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ textAlign: 'center', fontWeight: 700, fontSize: '1.5rem', color: '#ffffff', textDecoration: 'underline' }}>
                    2ª PARTE
                  </div>
                  {timelineRows2.length > 2 && (
                    <button onClick={() => setShowAllRows2(!showAllRows2)} style={{ background: '#6366f1', color: '#ffffff', border: 'none', borderRadius: '6px', padding: '0.2rem 0.6rem', fontWeight: 700, fontSize: '0.7rem', cursor: 'pointer', fontFamily: 'Inter, sans-serif', marginTop: '0.3rem' }}>
                      {showAllRows2 ? 'Mostrar menos' : `Ver todas (${timelineRows2.length})`}
                    </button>
                  )}
                  <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '0.5rem', tableLayout: 'fixed' }}>
                    <colgroup>
                    ...
                    <tbody>
                      {(showAllRows2 ? timelineRows2 : timelineRows2.slice(-2)).map((row, idx) => {
                        const realIdx = showAllRows2 ? idx : timelineRows2.length - 2 + idx;
                        return (
                          <tr key={realIdx}>
                            <td style={{ padding: '0.1rem 0.2rem', border: '1px solid var(--border-subtle)' }}>
                              <select value={row.action} onChange={(e) => {
                            ...
                            <td style={{ padding: '0.1rem 0.2rem', border: '1px solid var(--border-subtle)', background: '#1e293b', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem' }}>
                              ...
                              <button onClick={() => {
                                setTimelineRows2(prev => prev.filter((_, i) => i !== realIdx));
                              }} style={{ background: '#ef4444', color: '#ffffff', border: 'none', borderRadius: '4px', width: '20px', height: '20px', fontSize: '0.7rem', fontWeight: 900, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                ✕
                              </button>
                            </td>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                      <thead>
                        <tr style={{ background: 'rgba(251,191,36,0.1)' }}>
                          <th style={{ border: '1px solid var(--border-subtle)', padding: '0.5rem 0.8rem', textAlign: 'center', fontWeight: 800, fontSize: '0.85rem', textTransform: 'uppercase', color: '#ffffff' }}>Jornada</th>
                          <th style={{ border: '1px solid var(--border-subtle)', padding: '0.5rem 0.8rem', textAlign: 'center', fontWeight: 800, fontSize: '0.85rem', textTransform: 'uppercase', color: '#ffffff' }}>Rol</th>
                          <th style={{ border: '1px solid var(--border-subtle)', padding: '0.5rem 0.8rem', textAlign: 'center', fontWeight: 800, fontSize: '0.85rem', textTransform: 'uppercase', color: '#ffffff' }}>Encuentro</th>
                          <th style={{ border: '1px solid var(--border-subtle)', padding: '0.5rem 0.8rem', textAlign: 'center', fontWeight: 800, fontSize: '0.85rem', textTransform: 'uppercase', color: '#ffffff' }}>Resultado Descanso</th>
                          <th style={{ border: '1px solid var(--border-subtle)', padding: '0.5rem 0.8rem', textAlign: 'center', fontWeight: 800, fontSize: '0.85rem', textTransform: 'uppercase', color: '#ffffff' }}>Estado Descanso</th>
                          <th style={{ border: '1px solid var(--border-subtle)', padding: '0.5rem 0.8rem', textAlign: 'center', fontWeight: 800, fontSize: '0.85rem', textTransform: 'uppercase', color: '#ffffff' }}>Marca Primero</th>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '4.5rem' }}>
                          <table style={{ borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style={{ border: '1px solid var(--border-subtle)', padding: '0.4rem 0.5rem', color: '#39ff14', fontWeight: 900, whiteSpace: 'nowrap', textTransform: 'uppercase' }}>TOTAL</td>
                          ...
                          <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start', justifyContent: 'center', marginTop: '2rem' }}>
                            ...
                            {chartDataRival.length > 0 && (
                              <div style={{ width: 'fit-content', display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
                                <PieChart width={520} height={460} margin={{ top: 30, right: 80, bottom: 60, left: 80 }}>
                                  <Pie
                                    data={chartDataRival}
                                    cx="50%"
                                    cy="20%"
                              ...
                              <button type="button" onClick={(ev) => {
                                ...
                                doCut().then(blob => {
                                  ...
                                  setTrailPointsPorCorte(prev => ({ ...prev, [actionKey]: { points: trailSnapshot, videoTimeOffset: videoTimeSnapshot, cutStartSecs: totalSecs, duration: duracion } }));
                                                                 }).catch(err => { console.error('[Generar] error corte:', err); setCorteError(err.message || 'Error al generar el vídeo'); }).finally(() => { setGenerandoAccion(null); setProgresoAccion(prev => { const copy = Object.assign({}, prev); delete copy[actionKey]; return copy; }); });
              ...
              {activeTab === 'tipogol' && (
                <div style={{
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.75rem' }}>
                    ...
                    <button onClick={() => { if (logAction('TIRO DERECHA', 'origengol')) { setOrigenGolTiroDerechaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TIRO DERECHA' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TIRO DERECHA' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>TIRO DERECHA</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolTiroDerechaCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('TIRO IZQUIERDA', 'origengol')) { setOrigenGolTiroIzquierdaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TIRO IZQUIERDA' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TIRO IZQUIERDA' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>TIRO IZQUIERDA</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolTiroIzquierdaCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('TIRO FRONTAL', 'origengol')) { setOrigenGolTiroFrontalCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TIRO FRONTAL' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TIRO FRONTAL' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>TIRO FRONTAL</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolTiroFrontalCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('CENTRO DERECHA', 'origengol')) { setOrigenGolCentroDerechaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'CENTRO DERECHA' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'CENTRO DERECHA' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>CENTRO DERECHA</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolCentroDerechaCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('CENTRO IZQUIERDA', 'origengol')) { setOrigenGolCentroIzquierdaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'CENTRO IZQUIERDA' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'CENTRO IZQUIERDA' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>CENTRO IZQUIERDA</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolCentroIzquierdaCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('FALTA FRONTAL', 'origengol')) { setOrigenGolFaltaFrontalCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'FALTA FRONTAL' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'FALTA FRONTAL' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>FALTA FRONTAL</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolFaltaFrontalCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('FALTA DERECHA', 'origengol')) { setOrigenGolFaltaDerechaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'FALTA DERECHA' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'FALTA DERECHA' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>FALTA DERECHA</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolFaltaDerechaCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('FALTA IZQUIERDA', 'origengol')) { setOrigenGolFaltaIzquierdaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'FALTA IZQUIERDA' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'FALTA IZQUIERDA' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>FALTA IZQUIERDA</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolFaltaIzquierdaCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('CORNER DERECHA', 'origengol')) { setOrigenGolCornerDerechaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'CORNER DERECHA' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'CORNER DERECHA' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>CORNER DERECHA</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolCornerDerechaCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('CORNER IZQUIERDA', 'origengol')) { setOrigenGolCornerIzquierdaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'CORNER IZQUIERDA' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'CORNER IZQUIERDA' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>CORNER IZQUIERDA</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolCornerIzquierdaCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('PENAL', 'origengol')) { setOrigenGolPenalCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'PENAL' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'PENAL' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>PENAL</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolPenalCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('ERROR PROPIO', 'origengol')) { setOrigenGolErrorPropioCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'ERROR PROPIO' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'ERROR PROPIO' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>ERROR PROPIO</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolErrorPropioCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('ERROR RIVAL', 'origengol')) { setOrigenGolErrorRivalCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'ERROR RIVAL' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'ERROR RIVAL' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>ERROR RIVAL</span>
                      <span style={{ background: '#ffffff', color: '#ec4899', fontWeight: 900, fontSize: '1rem', padding: '0.2rem 0.7rem', borderRadius: '8px', minWidth: '30px', textAlign: 'center' }}>{origenGolErrorRivalCount}</span>
                    </button>
                    <button onClick={() => { if (logAction('PROPIA META', 'origengol')) { setOrigenGolPropiaMetaCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'PROPIA META' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'PROPIA META' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                    ...
                    <button onClick={() => { if (logAction('TRANSICION', 'origengol')) { setOrigenGolTransicionCount(prev => prev + 1); if (lastGoalType === 'GOL RIVAL') { setGolesRivalList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TRANSICION' }; } return newList; }); } else { setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TRANSICION' }; } return newList; }); } setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              ...
              {activeTab === 'goles' && (
                <div style={{
                  ...
                  {(() => {
                    ...
                    const titulars = players.filter(p => p.status === 'titular').map(p => p.name).filter(Boolean);
                    const subs = (Array.isArray(sustituciones) ? sustituciones : []).filter(s => s && s.sale && s.entra);
                    const onField = [...titulars];
                    subs.sort((a, b) => (a.minuto || 0) - (b.minuto || 0)).forEach(s => {
                      if (s.minuto <= currentMin) {
                        const outIdx = onField.indexOf(s.sale);
                        if (outIdx !== -1) { onField.splice(outIdx, 1); }
                        if (!onField.includes(s.entra)) { onField.push(s.entra); }
                      }
                    });
                    const onFieldUp = [...new Set(onField.map(n => n.toUpperCase()))];
                    window.__onFieldPlayers = onFieldUp;
                    return null;
                  })()}
                  {/* TODOS LOS GOLES */}
                  <button
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setGolesList(prev => {
                                const updated = [...prev];
                                updated[i] = { ...updated[i], tipo: val };
                                if (updated[i].name && val && updated[i].name2) { setActiveTab('acciones'); }
                                return updated;
                              });
                            }}
                            style={{
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              setGolesList(prev => {
                                const updated = [...prev];
                                updated[i] = { ...updated[i], name2: val };
                                if (updated[i].name && updated[i].tipo && val) { setActiveTab('acciones'); }
                                return updated;
                              });
                            }}
                            style={{
                          ...
                          onClick={() => {
                            if (g.team === 'away') {
                              setGolesRivalList(prev => {
                                const rivalIdx = prev.findIndex(rg => rg.periodo === g.periodo && rg.minuto === g.minuto);
                                if (rivalIdx !== -1) {
                                  return prev.filter((_, j) => j !== rivalIdx);
                                }
                                return prev;
                              });
                            }
              ...
              {activeTab === 'posesion' && (() => {
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem', width: '100%' }}>
                  ...
                  <div style={{ textAlign: 'center', color: '#ffffff', fontWeight: 900, fontSize: '1.4rem', letterSpacing: '0.04em', textTransform: 'uppercase' }}>
                    JORNADA {currentMatch?.matchday || '?'} — {currentMatch?.homeTeam || ''} <span style={{ textTransform: 'lowercase' }}>vs</span> {currentMatch?.awayTeam || ''}
                  </div>
                  {(() => {
