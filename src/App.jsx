            ...
            {activeTab === 'finalizaciones' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', width: '100%' }}>
                  ...
                  <div style={{ display: 'flex', gap: '2rem', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center' }}>
                      <button
                        onClick={() => { if (logAction('GOL', 'finalizacion')) { setGolCount(prev => prev + 1); setGolesList(prev => [...prev, { name: '', tipo: '', name2: '', accion: [...actionLog].find(e => e.type === 'accion') ? [...actionLog].find(e => e.type === 'accion').name : '', team: 'home', periodo, minuto: Math.floor(timerSeconds / 60) }]); setActiveTab('tipogol'); } }}
                        style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#16a34a', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', minWidth: 'fit-content', textTransform: 'uppercase', letterSpacing: '0.05em' }}
                      >
                        <span>GOL</span>
              ...
              {activeTab === 'tipogol' && (
                <div style={{
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.75rem' }}>
                    ...
                    <button onClick={() => { if (logAction('PENAL', 'origengol')) { setOrigenGolPenalCount(prev => prev + 1); setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'PENAL' }; } return newList; }); setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                      <span>PENAL</span>
                    ...
                    <button onClick={() => { if (logAction('TRANSICION', 'origengol')) { setOrigenGolTransicionCount(prev => prev + 1); setGolesList(prev => { const newList = [...prev]; if (newList.length > 0) { newList[newList.length - 1] = { ...newList[newList.length - 1], accion: 'TRANSICION' }; } return newList; }); setActiveTab('goles'); } }} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.6rem', background: '#ec4899', color: '#ffffff', fontWeight: 900, fontSize: '0.95rem', padding: '0.8rem 1.5rem', borderRadius: '12px', width: '100%', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
